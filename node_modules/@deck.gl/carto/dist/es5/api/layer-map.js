...
function getIconUrlAccessor(field, range, _ref8, data) {
  var fallbackUrl = _ref8.fallbackUrl,
      maxIconSize = _ref8.maxIconSize,
      useMaskedIcons = _ref8.useMaskedIcons;
...
function getSizeAccessor(_ref9, scaleType, aggregation, range, data) {
  var name = _ref9.name;
...
function getTextAccessor(_ref10, data) {
...
function getTextPixelOffsetAccessor(_ref11, radius) {
